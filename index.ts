function repeatedString(s: string, n: number): number {
  ...
  // rather than constructing a string of a given length,
  // we can figure out how many times that string wholely fits
  // in that length and then figure out the remainder to get the
  // remaining substring to search
